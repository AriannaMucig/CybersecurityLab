...
4. Attack and Kingdom Compromise Walkthrough
Initial Reconnaissance and Network Scanning
To map the network and discover the target, I first verified my Kali Linux local IP address using the ip a command, identifying it as 192.168.1.58/24. Next, I performed a ping scan across the subnet to locate active hosts:
...
Kingdom 2: The Wall & The North (HTTP Service & Virtual Hosting)
...
Kingdom 3: Iron Island (DNS Information Gathering)
...
Kingdom 4: Stormlands (Webmin Exploitation via Metasploit)
...
Kingdom 5: Mountain and the Vale (PostgreSQL & Base64 Encoding)
...
Kingdom 6: The Reach (Port-Knocking & IMAP Service)
...
Kingdom 7: The Rock and King’s Landing (GitList RCE & MySQL Privilege Escalation)
